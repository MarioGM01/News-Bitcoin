    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Proxy de CORS Anywhere
                const proxyUrl = 'https://cors-anywhere.herokuapp.com/';
                const apiUrl = 'https://newsapi.org/v2/everything?q=bitcoin&apiKey=06f607ab823343b682313f468c2bdc7b';
        ...
        // Asegúrate de habilitar CORS Anywhere antes de hacer la solicitud.
        fetchData();
    }, []);
